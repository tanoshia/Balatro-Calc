...
class BalatroTracker:
    ...
    def _setup_managers(self):
        ...
        # Labeling manager
        self.labeling_manager = LabelingManager(self.ui, self.modifier_manager)
    ...
    def _save_current_label(self):
        ...
        try:
            ...
            modifier_count = self._save_modifier_labels(card_path, label_text)
        ...
        try:
            ...
            if labeled_card_name == "Not a Card":
                ...
                if card_class is not None:
                    ...
                    self._update_matched_card_display(card_class, "Already Labeled")
                else:
    ...
    def _on_mode_change(self, event=None):
        ...
        if current_mode == "Manual Tracking":
            ...
            if not hasattr(self.ui, 'labeling_frame'):
                ...
                # Additional label category handlers - delegate to labeling manager
